...
const EjemploProps4 = props =>{
    return(
        <label>ver en consola
            <input type="text" onChange={(e) => props.cambiarvalor(e.target.value)}></input>
        </label>
    )
}
...
const EjemploProps5 = props =>{
    ...
    const handerClick = e =>{
        //para evitar errores - validación
...
export{
    ...
    EjemploProps4,
    EjemploProps5
    //acá usamos {} y no export default porque son varios componentes distintos lo que vamos a exportar
}